...
public class PrepareUpdateTelevisoreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String idDelTelevisoreCheVoglioModificare= request.getParameter("idDaInviareComeParametro");
		...
		try {
			result= televisoreServiceInstance.cercaTelevisorePerId(Long.parseLong(idDelTelevisoreCheVoglioModificare));
